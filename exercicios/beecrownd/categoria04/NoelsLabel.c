...
void readTranslations(Mapper* translations, int N);

void freeTranslations(Mapper* translations, int N);
...
int main(){
    ...
    readTranslations(translations, N);
    ...
    freeTranslations(translations, N);
    return 0;
}
